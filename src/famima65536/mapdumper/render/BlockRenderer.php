...
final class BlockRenderer{
    ...
    private function __construct(){
        ...
        //     $engine->putCube($position->x, $position->y, $position->z, new CubeInfo(Vector3::zero(), new Vector3(1, 7/8, 1), 0xffd68655), Cube::FACE_XZ & $faceToRender);
        //     $engine->putCube($position->x, $position->y, $position->z, new CubeInfo(new Vector3(0, 7/8, 0), new Vector3(1, 1/8, 1), 0xffd68655), Cube::FACE_YXZ & $faceToRender);
        // });
        // $this->registerSimple(VanillaBlocks::DIRT(), Color::fromRGB(0xd6_86_55));
        ...
        //     $engine->putCube($position->x, $position->y, $position->z, new CubeInfo(Vector3::zero(), new Vector3(1, 7/8, 1)), Color::fromRGB(0xd68655), Cube::FACE_XZ & $faceToRender);
        //     $engine->putCube($position->x, $position->y, $position->z, new CubeInfo(new Vector3(0, 7/8, 0), new Vector3(1, 1/8, 1)), Color::fromRGB(0x915631), Cube::FACE_YXZ & $faceToRender);
        // });
        ...
        //     $engine->putCube($position->x, $position->y, $position->z, new CubeInfo(Vector3::zero(), new Vector3(1, $snowLayer->getLayers()/SnowLayer::MAX_LAYERS, 1)), Color::fromRGB(0xf0f0f0), ($faceToRender & Cube::FACE_XZ) | Cube::FACE_Y);
        // });
        ...
        //         $engine->putCube($position->x, $position->y, $position->z, new CubeInfo($offset, $cube), $color, Cube::FACE_YXZ);
        //     }
        // });
    }

    private function setup() : void{
        $blockModelParser = new BlockModelParser(Main::RESOURCE_ROOT."/block_models.json");
        /** @var StringToItemParser */
        $stringToBlockParser = StringToItemParser::getInstance();
        foreach($blockModelParser->parse() as $modelEntry){
            $itemBlock = $stringToBlockParser->parse($modelEntry->blockName);
